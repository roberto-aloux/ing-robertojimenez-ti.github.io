var CircularProgressBar = function() {
    ...
    function n(n) {
        for (var r = 1; r < arguments.length; r++) {
            ...
            r % 2 ? t(Object(i), !0).forEach((function(t) { e(n, t, i[t]) })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(i)) : t(Object(i)).forEach((function(e) { Object.defineProperty(n, e, Object.getOwnPropertyDescriptor(i, e)) }))
        }
        return n
    }
    var r = { colorCircle: !1, colorCircle: "#E8EBF0", colorSlice: "#0076BC", end: 264, fontColor: "#0076BC", fontSize: "1.2rem", fontWeight: 400, lineargradient: !1, number: !0, opacity: 10, round: !1, size: 200, stroke: 10 };
    return function t(i) {
        var o = this;
        ! function(e, t) { if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, t), e(this, "initial", (function(e) {
            if ("IntersectionObserver" in window) {
                var t = new IntersectionObserver((function(e, t) { e.map((function(e) { e.isIntersecting && e.intersectionRatio > .75 && (o.createSvg(e.target), t.unobserve(e.target)) })) }), { root: null, rootMargin: "0px", threshold: 1 });
                e.map((function(e) { t.observe(e) }))
            } else e.map((function(e) { o.createSvg(e) }))
            ...
            if (c) {
                ...
                if (!(i > 100 || i < 0 || a === i)) {
                    var u, d = t ? 0 : a,
                        p = function e() { a >= s.percent ? d-- : d++, u = requestAnimationFrame(e), c.setAttribute("stroke-dasharray", 2.64 * d + ", 20000"), l && s.number && (l.textContent = "".concat(d, "%")), d === i && (c.setAttribute("data-angel", d), cancelAnimationFrame(u)) };
            ...
            var t = e.index,
                ...
                r = e.fontWeight,
                i = e.fontColor,
                c = document.createElementNS(o.svg, "text"),
                a = { class: "".concat(o.pieName, "-percent-").concat(t), x: "50%", y: "50%", "font-size": n, "font-weight": r, fill: i, "text-anchor": "middle", "dominant-baseline": "central" };
            return o.setAttr(c, a, !1), c
        })), e(this, "createSvg", (function(e) {
            var t = JSON.parse(e.getAttribute("data-pie")),
        ...
        })), e(this, "setAttr", (function(e, t) { var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2]; for (var r in t) n ? e.setAttributeNS(null, r, t[r]) : e.setAttribute(r, t[r]) })), this.pieName = i, this.svg = "http://www.w3.org/2000/svg";
        var c = document.querySelectorAll(".".concat(i)),
            a = [].slice.call(c);
        a.map((function(e, t) { e.setAttribute("data-index", t + 1) })), this.initial(a)
    }
}();